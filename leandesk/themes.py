...
SUITE_THEMES: dict[str, SuiteTheme] = {
    ...
    "Light": SuiteTheme("Light", "light", "Default bright office theme with slate text and cobalt accents.", _palette(bg="#eef1f6", panel="#ffffff", panel2="#e7ebf2", panel3="#d9e0ea", line="#c2cad7", text="#1e293b", muted="#626c80", cobalt="#356ae6", copper="#b85f2f", jade="#16866a", amber="#ad7500", orchid="#7d4bb3", coral="#bd4f62", danger="#c7374f", field="#ffffff", field_text="#1e293b", selection="#c9d9ff", ribbon="#f7f9fc", workspace="#d9dee7")),
